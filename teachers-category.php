...
if(strlen($_SESSION['alogin'])=="")
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query="INSERT INTO `tblcategories`(`name`, `photo`, `created_at`) 
    ...
    <head>
        ...
        <title>SMS Admin Create Category</title>
                                            ...
                                            <form method="post">
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <span class="help-block">Eg- Mudhir, Ustadh,Ustadha etc</span>
                                                    </div>
                                                </div>
