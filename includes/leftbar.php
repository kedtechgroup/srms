<div class="left-sidebar bg-black box-shadow">
    <div class="sidebar-content">
        ...
        <div class="user-info closed">
            <img src="../images/download.png" width="60" height="60" alt="John Doe" class="img-circle profile-img">
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-secondary">
                <li class="nav-header color-success">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="manage-exam-periods.php"><i class="fa fa-bars"></i> <span> Exam Years </span></a></li>
            ...
            <li class="has-children">
                ...
                <ul class="child-nav">
                    ...
                    <li><a href="auth-admin.php"><i class="fa fa-user-plus"></i> <span>Add User</span></a></li>
