                    ...
                    <div class="panel login-box">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <h4>Al Madrasatul Munawar Result System</h4>
                            </div>
                        </div>
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post">
                                <div class="form-group">
                                    <label for="rollid">Enter your Admission Number</label>
                                    <input type="text" class="form-control" id="rollid" placeholder="Enter Your Admission Number" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
