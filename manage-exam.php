                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="class_subjects.php?cid=<?php echo htmlentities($result->exam_id) ?>">
                                                                    ...
                                                                    <td>
                                                                        <a href="edit-class.php?classid=<?php echo htmlentities($result->exam_id); ?>">
                                                                            <i class="btn-sm btn-info">Edit</i>
                                                                        </a>
                                                                        <a href="delete-exam.php?exam_id=<?php echo htmlentities($result->exam_id); ?>">
