...
$sql = "SELECT * FROM tblclasses JOIN stream s on tblclasses.stream_id = s.stream_id WHERE id = $cid";
                                ...
                                <div class="row page-title-div">
                                    <div class="col-md-12">
                                        <h2 class="title"><i class="lead">Class:</i><?php echo htmlentities($result->ClassName) ?>
                                            . <i class="lead">Stream:</i> <?php echo htmlentities($result->name)  ?></h2>
                                    </div>
                                ...
                                <div class="row breadcrumb-div">
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="index.php"><i class="fa fa-home"></i> Classes </a></li>
                                                ...
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        ...
                                                        <div class="panel-title">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div>
                                                                    <h5> View <?php echo htmlentities($result->ClassName) ?> Exams
                                                                        <a style="float: right" class="btn btn-md btn-info" data-toggle="modal" data-target="#exampleModalCenter">
                                                                            <i class="fa fa-plus">
                                                                            </i> Add Class Exam
                                                                        </a>
                                                                    </h5>
                                                                ...
                                                                foreach ($results as $result) {   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                           ...
                                                                           <a href="../years/index.php"> <?php echo htmlentities($result->year_name); ?></a>
